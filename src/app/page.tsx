...
/* ── BUTTONS ── */
.btn-primary{display:inline-flex;align-items:center;padding:10px 24px;border-radius:9999px;border:none;font-family:var(--font-body);font-size:.85rem;font-weight:600;background:var(--accent);color:#fff;cursor:pointer;text-decoration:none;transition:all .25s var(--snappy);box-shadow:0 1px 2px rgba(0,0,0,.15),0 4px 12px rgba(61,107,61,.25);position:relative;letter-spacing:.01em}.btn-primary:hover{transform:translateY(-1px);box-shadow:0 2px 4px rgba(0,0,0,.15),0 8px 20px rgba(61,107,61,.3);filter:brightness(1.08)}.btn-primary:active{transform:translateY(0) scale(.985);box-shadow:0 1px 2px rgba(0,0,0,.12);filter:brightness(.95);transition-duration:80ms}
.btn-phone{display:inline-flex;align-items:center;gap:8px;padding:12px 28px;border-radius:9999px;border:1.5px solid rgba(61,107,61,.3);font-family:var(--font-body);font-size:.9rem;font-weight:600;background:rgba(61,107,61,.06);color:var(--accent);cursor:pointer;text-decoration:none;backdrop-filter:blur(12px);-webkit-backdrop-filter:blur(12px);transition:all .25s var(--snappy);min-width:320px;justify-content:center}.btn-phone:hover{background:var(--accent);color:#fff;border-color:var(--accent);transform:translateY(-1px)}.btn-phone:active{transform:translateY(0) scale(.988);transition-duration:80ms}
.txt-rotate{display:inline-block;min-width:140px;text-align:left}.txt-word{display:inline-block;animation:txtFade .4s var(--ease) both}@keyframes txtFade{from{opacity:0;transform:translateY(6px)}to{opacity:1;transform:none}}
...
.manifesto-glass p{font-family:var(--font-display);font-size:clamp(1.5rem,3.8vw,2.8rem);line-height:1.25;color:rgba(255,255,255,.92);letter-spacing:-.03em;text-shadow:0 1px 4px rgba(0,0,0,.25);position:relative;z-index:1;white-space:nowrap}
.manifesto-glass p span{color:#8ab98a;font-style:italic}
.busy-rotate{display:inline;cursor:default}.busy-word{display:inline;animation:busyIn .3s var(--ease) both;white-space:nowrap}@keyframes busyIn{from{opacity:0}to{opacity:1}}
...
export default function Home(){
  ...
  const caps=[
    ...
    {lbl:"Canvas",t:"Check due dates, submit work, reply to discussions while you nap.",icon:"/logos/canvas.png"},
