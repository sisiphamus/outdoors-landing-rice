...
.tool-strip{padding:40px 24px 0;overflow:hidden}.tool-strip-inner{display:flex;align-items:center;gap:clamp(28px,5vw,56px);animation:marquee 20s linear infinite;width:max-content}.tool-strip-inner:hover{animation-play-state:paused}@keyframes marquee{0%{transform:translateX(0)}100%{transform:translateX(-50%)}}.tool-icon{height:28px;width:auto;flex-shrink:0;opacity:.5;transition:opacity .2s,transform .2s}.tool-icon:hover{opacity:.85;transform:scale(1.1)}
