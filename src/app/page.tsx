...
.nature-word{display:block;width:clamp(200px,30vw,360px);height:clamp(80px,12vw,140px);border-radius:clamp(12px,2vw,20px);overflow:hidden;margin:20px auto 0;position:relative;box-shadow:var(--shadow-2)}.nature-img{width:100%;height:100%;object-fit:cover;position:absolute;inset:0;animation:natureIn .6s var(--ease) both}@keyframes natureIn{from{opacity:0;transform:scale(1.03)}to{opacity:1;transform:scale(1)}}
...
export default function Home(){
  ...
  const caps=[
    ...
    {lbl:"Canvas",t:"Check due dates, submit work, reply to discussions while you nap.",icon:"/logos/canvas.svg"},
